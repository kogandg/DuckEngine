...
{
    glUniform2fv(uniforms.at(name), 1, &value[0]);
}
...
{
    glUniform3fv(uniforms.at(name), 1, &value[0]);
}
...
{
    glUniform4fv(uniforms.at(name), 1, &value[0]);
}
...
{
    glUniformMatrix2fv(uniforms.at(name), 1, GL_FALSE, &mat[0][0]);
}

void Shader::SetMat3(const std::string& name, const glm::mat3& mat) const
{
    glUniformMatrix3fv(uniforms.at(name), 1, GL_FALSE, &mat[0][0]);
}
