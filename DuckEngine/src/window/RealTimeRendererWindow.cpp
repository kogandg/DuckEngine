...
void RealTimeRendererWindow::Init()
{
...

	{
		...
		floorMatData.textures["baseTexture"] = assetManager.LoadTexture(ResourcePath("textures/default.png"));
...

	{
		...
		vegMatData.textures["baseTexture"] = assetManager.LoadTexture(ResourcePath("textures/blending_transparent_window.png"));
