...
{
	shaderCache["default"] = std::make_shared<Shader>(ResourcePath("shaders/default.vert").c_str(), ResourcePath("shaders/default.frag").c_str());
	shaderCache["unlit"] = std::make_shared<Shader>(ResourcePath("shaders/unlit.vert").c_str(), ResourcePath("shaders/unlit.frag").c_str());
	shaderCache["phong"] = std::make_shared<Shader>(ResourcePath("shaders/phong.vert").c_str(), ResourcePath("shaders/phong.frag").c_str());
